...
// console.log() is used to print(AKA log) in the terminal
...
//1. Strings
var name= "Man withthe golden gun";
console.log('Hello I am'+ name);
var singquote = 'single quoted';
var doublequote = "doublequoted";
var backtick = `backticked`;
var MultiplePeople =`Tom
                    Solomon
                    Jerry`;
console.log(`Hi this is the only ${name}`)
console.log(MultiplePeople);
// The followint are template literals
// console.log(`Hi this is the only ${name}`)
// console.log(MultiplePeople);
// We can reference a single latter by its index
var str = 'Freshness';
console.log(str[0]);
str[0] = 'h'; // Wont work
// Strings are immutable, which mean that they cannot be changed( however, the variable can)
...
// Get a specific substring
    // A substring is any small potion of a string
        var fullName = 'Solomon;West';
var split = fullName.indexOf(';');
// slICE FULLNAME Into its first part starting from index 0 until the index of ; (ake divider)
var first = fullName.slice(0,split);
// slice fullname into its last part starting from the index of ; until the end
var last = fullName.slice(split+1,fullName.length);
// Show on the CLI
console.log(last);
var sName = last.toLowerCase();
var bName = last.toUpperCase();
...
str02 = str02.replace('.','!');
console.log(str02);
// highlight a variable and ctrl +d to rename all of the same name
// You can included JavaScript within backticks by using${}, which is called interpolation
// Backticks are very literal, until you close them out everything included new lines will be included
// Backticks are very literal, they include new line characters
var string5 = `
`
//  Single or double quotes will see a new line as a statement finisher
var string5 ='';
